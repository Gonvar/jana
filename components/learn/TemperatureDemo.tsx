...
const COLORS = [
  { bar: 'bg-sky-400', bg: 'bg-sky-50 border-sky-200', label: 'text-sky-700' },
  { bar: 'bg-sage-500', bg: 'bg-sage-50 border-sage-200', label: 'text-sage-600' },
  { bar: 'bg-amber-400', bg: 'bg-amber-50 border-amber-200', label: 'text-amber-700' },
]
  ...
  return (
    <div className="my-8 rounded-xl border border-sand-200 overflow-hidden">
      ...
      <div className="px-6 py-5">
        <p className="text-sm font-mono text-stone-500 mb-5 italic">
          &ldquo;{preset.prompt}&rdquo;
        </p>

        {/* Slider */}
        <div className="mb-6">
          <div className="flex justify-between text-xs text-stone-400 mb-1 font-sans">
            <span>Precise</span>
            <span>Creative</span>
          </div>
          <input
