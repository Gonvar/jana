...
<KeyIdea>
An agent is an AI that can take actions, not just talk. The skills Arnau built are agents — they use specific tools to do real tasks, not just describe how those tasks should be done.
</KeyIdea>
