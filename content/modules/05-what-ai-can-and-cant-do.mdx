...
<KeyIdea>
Trust AI with language tasks — drafting, formatting, synthesising, checking tone. Verify everything where being wrong has real consequences. The confidence of the output tells you nothing about its accuracy.
</KeyIdea>
